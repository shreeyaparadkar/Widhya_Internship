...
class Syntaxdb():
	def __init__(self, choice=0, search_query="",language=""):
		...
		# choice = 1 => It indicates concepts in particular language
		'''
	...
	def getContent(self):
		...
		'''
			...
			if choice is '1', the summary will have multiple items in list
		'''
...
if __name__=='__main__':
	TOKEN = '1517517918:AAEGCLUM8fdWOZaQZzxL7OPVVNMNhfy7OSc'
